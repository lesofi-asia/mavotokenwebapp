...
class MyHistory extends Component {
               ...
               <Table className={classes.table}>
                   ...
                   <TableBody>
                    {this.state.tableData.map( (row, index) => (
                        <TableRow key={index}>
                            <TableCell className={classes.column}><span className={classes.cellText}>{row.date}</span></TableCell>
                            <TableCell className={classes.column}><span className={classes.cellText}>{row.time}</span></TableCell>
                            <TableCell className={classes.column}><span className={classes.cellText}>{row.buyOrSell}</span></TableCell>
                            <TableCell className={classes.column}><span className={classes.cellText}>{row.pair}</span></TableCell>
  ...
  export default withStyles(styles)(MyHistory);